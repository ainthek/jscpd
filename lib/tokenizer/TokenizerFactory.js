      ...
      if (!(language in TokenizerFactory.prototype.tokenizers)) {
        switch (language) {
          ...
          case "csrc":
            ...
            TokenizerFactory.prototype.tokenizers[language].setType("text/x-" + language);
            break;
          case "typescript":
          case 'jsx':
            TokenizerFactory.prototype.tokenizers[language] = new TokenizerCodeMirror();
            TokenizerFactory.prototype.tokenizers[language].setType("javascript");
            break;
          default:
            TokenizerFactory.prototype.tokenizers[language] = new TokenizerCodeMirror();
            TokenizerFactory.prototype.tokenizers[language].setType(language);
        }
      }
