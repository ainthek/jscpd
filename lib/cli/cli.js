...
(function() {
  var JsCpd, TokenizerFactory, cli, logger, path;
  ...
  cli.parse({
    ...
    "languages": ['g', "list of languages which scan for duplicates, separated with comma", "string", Object.keys(TokenizerFactory.prototype.LANGUAGES).join(',')],
